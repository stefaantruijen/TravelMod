...
public class SlotTravelFurnaceOutput extends Slot
{
	private final EntityPlayer player;
	private int removeCount;
	
	public SlotTravelFurnaceOutput(EntityPlayer player, IInventory inventory, int index, int x, int y)
	{
	...
	public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack)
	{
		...
		this.player.addExperience((int) TravelFurnaceRecipes.getInstance().getTravelExperience(stack));
